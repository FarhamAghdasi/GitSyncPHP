...
$parts[] = "        echo json_encode(['success' => true, 'message' => \"\$deleted backup(s) deleted successfully\"]);";
$parts[] = "    } else {";
$parts[] = "        echo json_encode(['success' => false, 'message' => 'Error deleting some backups: ' . implode(', ', \$errors)]);";
$parts[] = "    }";
$parts[] = "    exit;";
$parts[] = "}";
$parts[] = "";
