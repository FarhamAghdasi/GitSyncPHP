    ...
    <div class="modal-content glass-card">
        ...
        <form id="settingsForm">
            <div class="settings-grid">
                ...
                <div class="form-group" style="grid-column: 1 / -1; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 20px; margin-top: 10px;">
                    <h4 style="color: var(--color-accent); margin-bottom: 15px;">Target Directory</h4>
                </div>
                <div class="form-group" style="grid-column: 1 / -1;">
                    ...
                    <small style="display: block; opacity: 0.5; margin-top: 5px;">
                        Directory where files will be updated (e.g., <?php echo htmlspecialchars(dirname(__DIR__)); ?>)
                    </small>
                </div>

                <div class="form-group" style="grid-column: 1 / -1; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 20px; margin-top: 10px;">
                    <h4 style="color: var(--color-accent); margin-bottom: 15px;">Proxy Settings</h4>
                </div>
                <div class="form-group">
                    <label class="checkbox-group">
